...
export default function App() {
  ...
  const AuthChoiceScreen = () => {
    ...
    const handleLoginUser = () => {
      if (email && password) setCurrentScreen('user_dashboard');
    };
    const handleLoginProvider = () => {
      if (email && password) setCurrentScreen('provider_dashboard');
    };
        ...
        <View style={styles.authCard}>
          ...
          <View style={styles.btnRow}>
            ...
            <TouchableOpacity style={styles.secondaryBtn} onPress={handleLoginProvider}>
              <Text style={styles.secondaryBtnText}>Login As Provider</Text>
            </TouchableOpacity>
          </View>
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      {currentScreen === 'auth_choice' && <AuthChoiceScreen />}
      {currentScreen === 'signup_user' && <SignupUserScreen />}
      {currentScreen === 'signup_provider' && <SignupProviderScreen />}
      {currentScreen === 'user_dashboard' && <UserDashboardScreen />}
      {currentScreen === 'provider_dashboard' && <ProviderDashboardScreen />}
    </SafeAreaView>
  );
}
